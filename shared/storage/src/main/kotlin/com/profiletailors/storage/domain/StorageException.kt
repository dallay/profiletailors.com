...
class StorageSecurityException(message: String) : StorageException(message)

class StorageServiceException(message: String, cause: Throwable? = null) : StorageException(message, cause)

class BucketNotFoundException(message: String) : StorageException(message)
 ...
 */
class StorageAccessDeniedException(message: String) : StorageException(message)
