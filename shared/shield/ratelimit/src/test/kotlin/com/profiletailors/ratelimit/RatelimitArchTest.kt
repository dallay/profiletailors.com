...
internal class RatelimitArchTest {
    ...
    fun domainShouldNotDependOnObservabilityFrameworks() {
        ObservabilityArchitectureRules.domainMustNotDependOnObservabilityVendors("com.profiletailors.ratelimit")
            .check(importedClasses)

        ObservabilityArchitectureRules.domainMustNotDependOnOperationalEventSink("com.profiletailors.ratelimit")
            .check(importedClasses)
    }

    @Test
    fun applicationShouldNotDependOnObservabilityImplementations() {
        ObservabilityArchitectureRules.applicationMustNotDependOnObservabilityVendors("com.profiletailors.ratelimit")
            .check(importedClasses)
    }
}
