...
None. This document describes the initial implementation of the user administration feature.
...
If a control endpoint returns `409 IDEMPOTENCY_KEY_REUSED`, the idempotency key was already used for a different operation or target. Use a fresh key.

If a control endpoint returns `404 USER_NOT_FOUND`, the target principal does not exist or is not a user-type principal.

## References

- [API versioning](./api-versioning.md)
- [Liquibase migration: `008-add-account-state.yaml`](./infrastructure/private-beta-operator-checklist.md)
- [Liquibase migration: `009-add-account-state.yaml`](./infrastructure/private-beta-operator-checklist.md)
- [Liquibase migration: `008-create-user-control-idempotency.yaml`](./infrastructure/private-beta-operator-checklist.md)
- [Liquibase migration: `009-fix-user-control-idempotency-scope.yaml`](./infrastructure/private-beta-operator-checklist.md)
