...
The project requires a fast, SEO-friendly marketing presence and a high-interactivity dashboard
application.
...
2. **Dashboard App**: Built with **Vue 3** (SPA). Uses **Pinia** for state management and *
...
- Reason rejected: Vue-only misses SEO benefits for marketing; Astro-only is less suited for the
  highly dynamic, stateful dashboard experience.
