...
*Detailed regional guidance and wave allocations are maintained in
the [`market-entry-asia.md`](market-entry-asia.md) strategy document.*
...
- [`readiness-checklist-japan.md`](readiness-checklist-japan.md): Standalone APPI Compliance
  Checklist for Japan
- [`readiness-checklist-singapore.md`](readiness-checklist-singapore.md): Standalone PDPA Compliance
