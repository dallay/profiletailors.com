...
import com.profiletailors.smp.integration.WorkspaceOwnershipEndpointIntegrationTest.TestJwtConfiguration
...
class WorkspaceOwnershipEndpointIntegrationTest {
    ...
    fun setUp() {
        ...
        kotlinx.coroutines.runBlocking {
            ...
            seedWorkspaceOwnershipScenario()
        }
    }
    ...
    private suspend fun seedWorkspaceOwnershipScenario() {
        ...
        databaseClient.sql("INSERT INTO user_identities (principal_id, email, username) VALUES ('outsider-1', 'outsider@example.com', 'outsider-one')").fetch().rowsUpdated().awaitSingle()
    ...
    private fun applyLiquibaseBaseline() {
        DriverManager.getConnection(
            "jdbc:h2:mem:workspace_ownership;MODE=PostgreSQL;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE",
            "sa",
            "",
        ).use { connection ->
