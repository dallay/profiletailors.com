...
@Service
internal class AnalyzeHashtagsHandler(private val hashtagAnalysis: HashtagAnalyzer) :
    ...
    override suspend fun handle(query: AnalyzeHashtagsQuery): HashtagAnalysisResult {
        val analysis = hashtagAnalysis.analyze(query.content)
...
@Service
internal class GetTrendingHashtagsHandler(private val hashtagAnalysis: HashtagAnalyzer) :
    ...
    override suspend fun handle(query: GetTrendingHashtagsQuery): TrendingHashtagsResult {
        val trending = hashtagAnalysis.analyze("").suggestedHashtags
