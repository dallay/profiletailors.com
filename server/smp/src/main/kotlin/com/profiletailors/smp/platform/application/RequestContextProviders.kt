...
class StoreBackedPrincipalContextProvider(private val requestContextStore: RequestContextStore) :
    PrincipalContextProvider {
    override suspend fun current(): PrincipalContext? = requestContextStore.currentPrincipalContext()
}

class StoreBackedResourceContextProvider(private val requestContextStore: RequestContextStore) :
    ResourceContextProvider {
    override fun current(): ResourceContext? = requestContextStore.currentResourceContext()
}

class StoreBackedRequestPathProvider(private val requestContextStore: RequestContextStore) : RequestPathProvider {
