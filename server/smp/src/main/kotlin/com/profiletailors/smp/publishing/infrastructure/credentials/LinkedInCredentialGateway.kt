...
class R2dbcLinkedInCredentialGateway(
    ...
    override suspend fun resolveCredential(id: UUID): LinkedInCredentials = db.sql(
        """
    ...
    private suspend fun findExistingCredentialId(ownerType: String, ownerId: UUID): UUID? = db.sql(
        """
            SELECT id
            FROM secure_credentials
