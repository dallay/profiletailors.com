...
(Previously: Authorization outcomes had to be attributable to explicit facts, including entitlements, but the spec did not require the existing proving slice to distinguish missing-entitlement deny from missing-permission deny.)
