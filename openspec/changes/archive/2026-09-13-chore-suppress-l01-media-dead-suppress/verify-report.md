...
- contract: amended spec (`specs/code-hygiene/spec.md` — Req 1 = 1-deletion `MediaHandlers.kt:243`; new Req = deferred debt `StaleAssetReconciler.kt:96` retained byte-identical)
...
**PASS** — All amended-contract scenarios compliant on measured evidence: 1-deletion diff exact, deferred line byte-identical, lint/check gates green, zero new `@Suppress`, baseline and protected files untouched. No code rework needed. Ready for archive.
