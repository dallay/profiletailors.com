...
- **Risk**: Low — adds test coverage for existing `OperatorAccessResolver` and
  `AdminOperatorController` behavior
...
**PASS** — Test-only change. QA evidence is the successful test run confirming new cases pass and no
regressions exist.
