...
Administrative authorization boundary for platform admin operators. Adds `OperatorAccessResolver`
with default-deny semantics and strips `user-` prefixed principal IDs before repository lookup.
