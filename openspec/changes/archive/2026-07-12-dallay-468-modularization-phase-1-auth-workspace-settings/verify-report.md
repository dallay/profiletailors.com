...
| Coverage | NOT RUN | No coverage command required by artifacts; behavior preservation was proven through focused runtime tests. |
...
2. Raw changed-line count is far above the original 250-380 estimate when untracked moved files are included. This is expected for physical relocation but should be called out in PR notes.
