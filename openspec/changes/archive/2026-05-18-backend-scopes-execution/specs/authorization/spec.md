...
this capability.
This change MUST remain limited to this one target-aware proving capability and MUST NOT retrofit
scope execution onto `/api/authorization/workspace-access/current`.
