...
> because the spec scenarios' covering runtime proof stops at the advice/exception layer and does not
...
> documented inline in `PublishingControllersTest.kt` (lines 443–450): the production controller uses
