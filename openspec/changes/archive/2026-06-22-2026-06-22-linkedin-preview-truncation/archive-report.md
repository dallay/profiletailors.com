...
- Notes: Task 3.4 command wording was documented as inconsistent, but verification confirmed the correct Vue workspace command was used and all runtime/type-check gates passed.

## Outcome

This change is fully archived. The source-of-truth spec now reflects the LinkedIn preview truncation behavior and the provider-specific preview seam introduced through `PostPreviewPanel` and `LinkedInPostPreview`.
