...
When public registration is disabled, a valid invitation token MUST allow the invited email to
complete registration. Identity creation, invitation consumption, consent recording, and membership
reconciliation MUST commit atomically, and the issued session MUST carry the invitation workspace
context. An invalid, expired, revoked, consumed, or email-mismatched invitation MUST roll back
registration artifacts and membership changes.
