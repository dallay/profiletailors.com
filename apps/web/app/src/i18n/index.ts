...
const messages = {
  en: {
    ...
    composer: {
      ...
      mediaPicker: {
        title: 'Media Library',
        description: 'Browse reusable workspace media for this post.',
        open: 'Open media library',
        close: 'Close media library',
        searchLabel: 'Search media',
        searchPlaceholder: 'Filename or MIME type',
        filterLabel: 'Filter media type',
        filterAll: 'All media',
        filterImage: 'Images',
        filterVideo: 'Videos',
        filterDocument: 'Documents',
        assetGridLabel: 'Available media assets',
        loading: 'Loading media library...',
        emptyTitle: 'No reusable media yet',
        emptyBody: 'Media assets will appear here once your workspace library has content.',
        errorTitle: 'Unable to load media library',
        errorBody: 'Try again later or adjust your library inputs.',
  ...
  es: {
    ...
    composer: {
      ...
      mediaPicker: {
        ...
        description: 'Explora medios reutilizables del workspace para esta publicación.',
        open: 'Abrir librería de medios',
        close: 'Cerrar librería de medios',
        searchLabel: 'Buscar medios',
        searchPlaceholder: 'Nombre de archivo o tipo MIME',
        filterLabel: 'Filtrar tipo de medio',
        filterAll: 'Todos los medios',
        filterImage: 'Imágenes',
        filterVideo: 'Videos',
        filterDocument: 'Documentos',
        assetGridLabel: 'Assets multimedia disponibles',
        loading: 'Cargando librería de medios...',
        emptyTitle: 'Aún no hay medios reutilizables',
        emptyBody: 'Los assets aparecerán aquí cuando la librería del workspace tenga contenido.',
        errorTitle: 'No se pudo cargar la librería de medios',
        errorBody: 'Inténtalo más tarde o ajusta las entradas de la librería.',
        disabledTitle: 'Librería de medios no disponible',
        disabledBody:
