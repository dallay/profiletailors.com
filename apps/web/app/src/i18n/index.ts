  ...
  en: {
    ...
    dashboard: {
      ...
      quickStart: {
        ...
        step3Desc: 'Set base URL to <span class="text-text-display font-mono">{baseUrl}</span> in your IDE or API client.',
        step4Title: '4. Monitor & optimize',
        step4Desc: 'Track tokens, cost and errors in Request Logs and Analytics.',
      },
    },
    composer: {
      title: 'Create Post',
  ...
  es: {
    ...
    dashboard: {
      ...
      quickStart: {
        ...
        step2Desc: 'Añade cuentas en Proveedores. Soporta OAuth, Clave API y niveles gratuitos.',
        step3Title: '3. Dirige tu cliente',
        step3Desc: 'Establece la URL base en <span class="text-text-display font-mono">{baseUrl}</span> en tu IDE o cliente API.',
        step4Title: '4. Monitorear y optimizar',
        step4Desc: 'Rastrea tokens, costes y errores en Logs de Solicitudes y Analítica.',
      },
    },
    composer: {
