  ...
  en: {
    ...
    dashboard: {
      ...
      quickStart: {
        ...
        step3Desc: 'Set base URL to https://omnirouter.ahome.quest/v1 in your IDE or API client.',
  ...
  es: {
    ...
    dashboard: {
      ...
      quickStart: {
        ...
        step3Desc: 'Establece la URL base en https://omnirouter.ahome.quest/v1 en tu IDE o cliente API.',
