...
<template>
  <div class="space-y-8">
    <div class="flex flex-col gap-3 border-b border-border-subtle pb-6 lg:flex-row lg:items-end lg:justify-between">
      <div class="space-y-2">
        <p class="label-mono text-[10px] text-text-secondary">
          {{ $t('nav.settings') }}
        </p>
      ...
      <div class="rounded-2xl border border-border-subtle bg-bg-surface px-4 py-3">
        <p class="font-mono text-[10px] uppercase tracking-[0.14em] text-text-secondary">
          {{ $t('workspace.title') }}
        </p>
        <p class="mt-1 text-sm font-medium text-text-display">{{ displayWorkspaceName }}</p>
      </div>
    </div>

    <div class="grid gap-6 xl:grid-cols-[minmax(0,1.12fr)_minmax(320px,0.88fr)]">
      <div class="space-y-6">
        <Card
          class="border bg-bg-surface transition-colors"
          :class="channelsPanelFocused
            ? 'border-text-display shadow-[0_0_0_1px_rgba(255,255,255,0.14)]'
        ...
        <Card class="border border-border-subtle bg-bg-surface">
          <CardHeader class="space-y-3 border-b border-border-subtle p-0 pb-5">
            <CardTitle class="label-mono text-[10px] text-text-display">
              {{ $t('workspace.title') }}
            </CardTitle>
            ...
            <div class="space-y-4">
              <div class="grid grid-cols-6 gap-2 sm:grid-cols-8">
                <button
                  ...
                  type="button"
                  :aria-label="iconName"
                  class="flex size-10 items-center justify-center rounded-xl border transition-all"
      ...
      <div class="space-y-6">
        <Card class="border border-border-subtle bg-bg-surface">
          <CardHeader class="border-b border-border-subtle p-0 pb-5">
          ...
          <CardContent class="mt-6 space-y-6 p-0">
            <div class="flex items-center justify-between gap-4">
              <div>
                <span class="block text-sm font-medium text-text-display">{{ $t('settings.languageLabel') }}</span>
            ...
            <div class="border-t border-border-visible pt-6">
              <div class="flex items-center justify-between gap-4">
                <div>
                  <span class="block text-sm font-medium text-text-display">{{ $t('settings.themeLabel') }}</span>
