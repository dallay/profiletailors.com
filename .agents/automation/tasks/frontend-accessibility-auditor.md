...
Prefer semantic HTML; do not redesign UX or claim full WCAG. If uncertainty persists, record it and continue safe unrelated work.
...
Owns ../state/frontend-accessibility.yaml; use the framework schema and never set execution data without an actual run.

## Report

Owns ../reports/frontend-accessibility.md; report facts, evidence, result, validation, unresolved findings, and risks without chain-of-thought or secrets.

## Pull Request

Create exactly one Draft Pull Request with framework sections. Suggested title: fix(a11y): correct deterministic accessibility regressions.
