...
Never redesign navigation or authorization. If uncertainty persists, record it and continue safe unrelated work.
...
Owns ../state/frontend-route-navigation.yaml; use the framework schema and never set execution data without an actual run.

## Report

Owns ../reports/frontend-route-navigation.md; report facts, evidence, result, validation, unresolved findings, and risks without chain-of-thought or secrets.

## Pull Request

Create exactly one Draft Pull Request with framework sections. Suggested title: fix(frontend): reconcile verified route drift.
