...
Read ../state/frontend-route-navigation-auditor.yaml as context and revalidate every finding.
...
Owns ../state/frontend-route-navigation-auditor.yaml; use the framework schema and never set execution data
without an actual run.

## Report

Owns ../reports/frontend-route-navigation-auditor.md; report facts, evidence, result, validation, unresolved
