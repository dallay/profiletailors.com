...
Owns ../state/feature-flag-audit.yaml; use the framework schema and never set execution data without
an actual run.

## Report

Owns ../reports/feature-flag-audit.md; report facts, evidence, result, validation, unresolved
