...
Owns ../state/api-contract-drift.yaml; use the framework schema and never set execution data without
an actual run.

## Report

Owns ../reports/api-contract-drift.md; report facts, evidence, result, validation, unresolved
