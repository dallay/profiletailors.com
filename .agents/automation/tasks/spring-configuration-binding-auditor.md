...
Read ../state/spring-configuration-binding-auditor.yaml as context and revalidate every finding.
...
Owns ../state/spring-configuration-binding-auditor.yaml; use the framework schema and never set execution
data without an actual run.

## Report

Owns ../reports/spring-configuration-binding-auditor.md; report facts, evidence, result, validation,
