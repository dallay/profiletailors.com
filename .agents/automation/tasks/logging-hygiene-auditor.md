...
Never reproduce sensitive values in reports. If uncertainty persists, record it and continue safe
unrelated work.
...
Create exactly one Draft Pull Request with framework sections. Suggested title: chore(logging):
remove deterministic unsafe logging.
