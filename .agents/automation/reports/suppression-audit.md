...
| `apps/web/app/src/components/ui/carousel/CarouselContent.vue` | `biome-ignore lint/correctness/noUnusedVariables` | Required | Retained |
| `server/smp/src/main/kotlin/...` | Detekt `@Suppress` | Required | Retained |
