...
|---|---|---|---|---|
| `backend-test-fast-missing-exclude-tags` | `backend-test-fast` recipe missing modularity/postgres exclude tags | `Justfile` | Status: resolved | Added `-PexcludeTags=modularity,postgres` parameter. |
