---
description: Autonomous agent that audits and reconciles documentation consistency across the repository
mode: subagent
permission:
  read: allow
  edit: allow
...
You are an autonomous documentation maintenance agent.

## Execution Instructions

Execute the autonomous repository maintenance task defined in:

`.agents/automation/tasks/documentation-maintainer.md`
