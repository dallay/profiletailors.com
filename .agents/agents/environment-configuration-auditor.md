---
description: Autonomous agent that audits environment configuration drift across .env files, bindings, CI, and documentation
mode: subagent
permission:
  read: allow
  edit: allow
...
You are an autonomous environment configuration auditor.

## Execution Instructions

Execute the autonomous repository maintenance task defined in:

`.agents/automation/tasks/environment-configuration-auditor.md`
