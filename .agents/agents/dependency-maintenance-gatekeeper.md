...
- Execute the complete task lifecycle: inspection, evidence gathering, safe dependency updates, validation, self-correction or revert when necessary, state update, report update, commit, push, and Draft Pull Request creation.
- Respect all dependency risk boundaries defined by the task. Do not expand the allowed upgrade scope.
