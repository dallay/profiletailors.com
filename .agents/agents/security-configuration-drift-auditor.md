...
- Treat runtime security behavior as HIGH RISK unless the task definition explicitly permits a deterministic evidence-backed correction.
- Never weaken authentication, authorization, CSRF protection, CORS restrictions, cookie security, or other security controls.
- When a safe runtime correction cannot be conclusively proven, persist the finding and continue unrelated safe work.
