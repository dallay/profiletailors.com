...
- For every attempted correction, validate the smallest relevant scope first and retain the change only when the implementation is correct and validation supports it.
