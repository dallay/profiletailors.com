...
> from `com.profiletailors.common.domain.Service` (NOT Spring's `@Service`). This allows them to be
...
@Service  // com.profiletailors.common.domain.Service - NOT org.springframework.stereotype.Service
