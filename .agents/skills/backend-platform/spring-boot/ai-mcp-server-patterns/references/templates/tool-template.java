 ...
 * <p>
 * Follow these best practices when creating tools: 1. Use descriptive names and clear descriptions
 * 2. Document all parameters with @ToolParam 3. Implement proper validation 4. Handle errors
 * gracefully 5. Return structured results 6. Consider security implications 7. Add appropriate
 * logging 8. Implement rate limiting if needed 9. Use caching for expensive operations 10. Test
 * thoroughly
 */
@Component
public class ToolTemplate {
  ...
  /**
   * Brief description of what this tool does. Make it clear and concise - this is used by AI models
   * to understand when to invoke the tool.
   * <p>
   * Include: What the tool does, expected inputs, return value Example: "Calculate the square root
  ...
  /**
   * Tool with complex input/output. Shows how to handle structured data.
   */
  @Tool(
      description = """
  ...
  /**
   * Tool that performs expensive operation. Shows caching pattern.
   */
  @Tool(
  ...
  /**
   * Tool with rate limiting. Shows how to protect against abuse.
   */
  @Tool(
