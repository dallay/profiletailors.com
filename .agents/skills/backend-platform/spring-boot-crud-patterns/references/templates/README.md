...
- It uses Python string.Template placeholders (e.g., $package, $entity, $id_type, $
  id_name, $id_name_lower, $base_path, $dto_request, $dto_response).
...
- Application layer uses ${Entity}Mapper for DTO↔Domain and throws ${Entity}ExistException on
  duplicates
