...
This file covers **single-user scenarios** with multiple browser tabs, windows, and popups. For *
*multi-user collaboration testing** (multiple users interacting simultaneously),
see [multi-user.md](multi-user.md).
...
> **For multi-user collaboration patterns** (admin/user interactions, real-time collaboration,
> role-based testing, concurrent actions), see [multi-user.md](multi-user.md). This file focuses on
> single-user scenarios with multiple tabs/windows/popups.
