...
name: observer
description: >
  Apply, review, or refactor code using the Observer design pattern.
...
Publisher/Subject, Subscriber/Observer, ConcreteSubscribers.
...
```kotlin
data class WaitlistJoined(val email: String)
