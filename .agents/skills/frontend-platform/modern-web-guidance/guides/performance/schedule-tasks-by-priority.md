When building complex web applications, tasks have different levels of urgency. Completing tasks for
the current view is more important than sending analytics or prefetching assets. The Prioritized
Task Scheduling API allows you to schedule work with specific priorities, ensuring the browser
...
To support browsers that do not have the Prioritized Task Scheduling API, you must use a polyfill to
